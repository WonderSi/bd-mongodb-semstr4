...
const defectInfoSchema = new Schema({
  ...
  defect_rate_percent: { type: Number, default: 0 },
  last_defect_date: { type: Date },
  defect_suppliers: [{ type: Schema.Types.ObjectId, ref: 'Supplier' }]
}, { _id: false });
